...
ORDER          = ['fanart-exodusredux', 'fanart-gaia', 'fanart-thecrew', 'fanart-metadatautils', 'fanart-premiumizer', 'fanart-realizer', 'imdb-exodusredux', 'imdb-gaia', 'imdb-thecrew', 'imdb-premiumizer', 'imdb-realizer', 'kitsu-wonderfulsubs', 'login-iagl', 'login-netflix', 'mal-wonderfulsubs', 'omdb-metadatautils', 'omdb-metahandler', 'login-opensubtitles', 'login-opensubsbyopensubs', 'login-orion', 'tmdb-exodusredux', 'login-eis', 'tmdb-gaia', 'tmdb-metadatautils', 'tmdb-eis', 'tmdb-openmeta', 'tmdb-thecrew', 'tmdb-premiumizer', 'tmdb-realizer', 'tmdb-seren', 'trakt-openmeta', 'trakt-seren', 'tvdb-metahandler', 'tvdb-openmeta', 'tvdb-premiumizer', 'tvdb-realizer', 'tvdb-seren', 'location-yahoo', 'ws-wonderfulsubs']
