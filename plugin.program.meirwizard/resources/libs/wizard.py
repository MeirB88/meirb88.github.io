        ...
        if DIALOG.yesno(ADDONTITLE, "[COLOR %s]Are you sure you wish to backup the current build?[/COLOR]" % COLOR2, nolabel="[B][COLOR red]Cancel Backup[/COLOR][/B]", yeslabel="[B][COLOR springgreen]Backup Build[/COLOR][/B]"):
            ...
            if 'addon_data' in exclude_dirs:
                ...
                for fold in match:
                    ...
                    if not fd in ['skin.confluence', 'skin.re-touch', 'skin.estuary', 'skin.estouchy', 'skin.estuary', 'skin.aura', 'skin.eminence.2.mod', 'skin.eminence.2.mod.Krypton', 'skin.fuse.neue']:
...
def skinToDefault(title):
    if not currSkin() in ['skin.confluence', 'skin.estuary', 'skin.aura', 'skin.eminence.2.mod', 'skin.eminence.2.mod.Krypton', 'skin.fuse.neue']:
