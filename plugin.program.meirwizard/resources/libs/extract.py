...
def allWithProgress(_in, _out, dp, ignore, title):
	...
	for item in zin.infolist():
		...
		elif item.filename == 'userdata/Database/MyVideos107.db' and KEEPINFOWATCH =='false':skip=True
		elif item.filename == 'userdata/Database/MyVideos116.db' and KEEPINFOWATCH =='false':skip=True
		elif file[0] == 'userdata' and file[1] == 'addon_data' and file[2] == 'script.module.metahandler' and KEEPINFOWATCH =='true':skip=True
		elif item.filename == 'userdata/guisettings.xml' and KEEPSETTINGS == 'true': skip = True
